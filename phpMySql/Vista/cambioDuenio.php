...
<div class="container">
        ...
        <form class="needs-validation" novalidate method="post" action="accion/accionCambioDuenio.php" >
        <table>
            <tr>
            ...
            <tr>
                <td colspan="2"><input class="form-control mb-2" type="submit" value="Cambiar"> </td>
            </tr>
        </table>
        </form>
