...
<div class="container">
        ...
        <form class="needs-validation" novalidate method="post" action="accion/accionNuevoAuto.php">
        <table>
            <tr>
                <td>Ingrese la patente:</td>
                <td><input class="form-control mb-2" type="text" name="Patente" required></td>
            </tr>
            <tr>
                <td>Ingrese la marca:</td>
                <td><input class="form-control mb-2" type="text" name="Marca" required></td>
            </tr>
            <tr>
                <td>Ingrese el modelo:</td>
                <td><input class="form-control mb-2" type="number" name="Modelo" required></td>
            </tr>
            <tr>
                <td>Ingrese el DNI del dueño:</td>
                <td><input class="form-control mb-2" type="number" name="DniDuenio" required></td>
            </tr>
            <tr>
