...
<div class="container mt-4">
    ...
    <form action="../Control/control-ejercicio3.php" method="post" enctype="multipart/form-data">
        <div class="row mb-3">
            <div class="col-md-6">
    ...
    <?php if (isset($datos) && count($datos) > 0 && (!isset($errores) || count($errores) === 0)): ?>
        <div class="alert alert-success mt-4" style="background-color: #e6f4e6;">
            ...
            <?php if (isset($datos['imagen'])): ?>
                <div class="mt-3">
                    <img src="<?= htmlspecialchars($datos['imagen']) ?>" alt="Imagen de la película" >
                </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
